...
def main():
    ...
    train, test = chainer.datasets.split_dataset_random(dataset, min(64*4, int(len(dataset) * 0.01)), seed=0)
    ...
    trainer.extend(chainer.training.extensions.LogReport(trigger=(2, "iteration")))
